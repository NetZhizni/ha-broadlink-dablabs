...
async def async_setup_entry(
    ...
    remote = BroadlinkRemote(
        device,
        Store(
            hass, CODE_STORAGE_VERSION, f"broadlink_dablabs_remote_{device.unique_id}_codes"
        ),
        Store(
            hass, FLAG_STORAGE_VERSION, f"broadlink_dablabs_remote_{device.unique_id}_flags"
        ),
    )
