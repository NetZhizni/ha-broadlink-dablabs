...
from . import blk
from .blk.exceptions import AuthorizationError, BroadlinkException
from .const import DOMAINS_AND_TYPES
...
class BroadlinkRMUpdateManager(BroadlinkUpdateManager[blk.rmmini]):
    ...
    async def async_fetch_data(self) -> dict[str, Any]:
        ...
        if device.api.type in DOMAINS_AND_TYPES[Platform.SENSOR]:
